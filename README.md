...
VIPER's job isn't to identify correlations between transcription factors and gene expressions. VIPER's job is to quantify the accuracy of the results generated by GRNBoost2's machine learning model. 
