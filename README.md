...
├── MOSTEXPRESSED/
│   └── apply-viper-evaluation_control_mostexpressed.ipynb  # GRNBoost2 control: most expressed genes
├── MOSTVARIABLE/
│   └── apply-viper-evaluation_control_mostvariable.ipynb   # GRNBoost2 control: 100 most variable genes
└── resources/
